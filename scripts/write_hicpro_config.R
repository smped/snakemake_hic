...
## Download the HiC-Pro config file from the repo for v3.0.0
orig <- readLines(
  "https://github.com/nservant/HiC-Pro/blob/fe045f68fb6af88f3ebd0e2609000e76ddcb7c1c/config-hicpro.txt"
  )
